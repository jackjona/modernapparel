  ...
  return (
    ...
    {/*
      <div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:mt-24 md:mt-24 text-center">
          <h1 className="font-extrabold text-gray-900">
            <p className="text-xl sm:text-3xl md:text-4xl">
              FAQ
            </p>
            <p className="py-6 text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-6xl sm:text-6xl md:text-7xl">
              Frequently Asked Questions:
            </p>
          </h1>
        </div>
        <section className="px-4 pt-20 pb-36 mx-auto max-w-7xl md:px-2">
