    ...
    <header className="text-gray-600 dark:text-gray-200 body-font">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        >
          ...
          <span className="ml-3 text-xl dark:text-gray-200">
            Modern Apparel
          </span>
        </a>
        <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-base justify-center">
          ...
          <a
            className="mr-5 hover:text-gray-900 dark:hover:text-gray-100 border-black hover:border-b-2"
            href="https://modernapparel.vercel.app/search/mens-apparel"
          >
            Mens
          </a>
          <a
            className="mr-5 hover:text-gray-900 dark:hover:text-gray-100 border-black hover:border-b-2"
            href="https://modernapparel.vercel.app/search/womens-apparel"
          >
            Womens
          </a>
          <a
            className="mr-5 hover:text-gray-900 dark:hover:text-gray-100 border-black hover:border-b-2"
            href="https://modernapparel.vercel.app/search/accessories"
          >
            Accessories
          </a>
        </nav>
